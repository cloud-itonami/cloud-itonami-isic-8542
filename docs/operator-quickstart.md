# Operator Quickstart — Cultural education

Shortest path from clone to a verified local dry-run for **ISIC 8542** (`cloud-itonami-isic-8542`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-8542.git
cd cloud-itonami-isic-8542
```
...
- Blueprint governor key: `instruction-integrity-governor`
- Likely source path: `cultural.governor.cljc`
